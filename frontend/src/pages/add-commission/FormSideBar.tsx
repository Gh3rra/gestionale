...
import { CommissionStepIcon, CustomerStepIcon, LocationIcon, SummaryIcon } from "../../Icon";
import Step from "../../components/Stepper/Step/Step";
import Stepper from "../../components/Stepper/Stepper";

const descriptionStep: Record<number, string> = {
  0: "Compila i dettagli della commessa",
...
function FormSideBar({
  ...
  return (
    <div className="bg-hover flex h-full w-1/4 flex-col rounded-l-[20px] px-10 py-10">
      <p className="text-xl font-medium">Inserimento Commessa</p>
